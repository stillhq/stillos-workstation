...
dnf swap -y gnome-shell https://download.copr.fedorainfracloud.org/results/still/stillos-alma/rhel+epel-10-x86_64/10837168-gnome-shell/gnome-shell-49.4-9.el10.still.1.x86_64.rpm
dnf install -y https://download.copr.fedorainfracloud.org/results/still/stillos-alma/rhel+epel-10-x86_64/10837768-mutter/mutter-common-49.4-8.el10.stillos.1.noarch.rpm
dnf swap -y mutter https://download.copr.fedorainfracloud.org/results/still/stillos-alma/rhel+epel-10-x86_64/10837768-mutter/mutter-49.4-8.el10.stillos.1.x86_64.rpm
