...
dnf install -y /ctx/system_files/rpms/mutter-common-49.4-5.el10.stillos.1.noarch.rpm
dnf swap -y mutter /ctx/system_files/rpms/mutter-49.4-5.el10.stillos.1.x86_64.rpm
