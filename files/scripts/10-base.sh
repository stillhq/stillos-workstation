...
dnf copr enable still/stillos-10-wayland-enablement-stack rhel+epel-10-x86_64 -y
sudo dnf config-manager \
  --setopt='copr:copr.fedorainfracloud.org:still:stillos-10-wayland-enablement-stack.priority=1' \
  --save
